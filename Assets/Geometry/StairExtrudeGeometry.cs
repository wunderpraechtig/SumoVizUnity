...
public class StairExtrudeGeometry : Geometry
{
    ...
    public static void CreateMesh(string name, List<Vector2> coordFirst, List<Vector2> coordSecond
        , float A_x, float B_y, float C_z, float pxUp, float pyUp, float pxDown, float pyDown, ref List<Mesh> stairMeshes)
    {
